...
const annuler = async () => {
  router.push(`/admoin/tableaux/${idTableau}/colonnes/${idColonne}/taches/${idTache}/commentaires`)
}
const valider = async () => {
  if(texte.value==="" ){
  ...
  try {
      ...
      router.push(`/admin/tableaux/${idTableau}/colonnes/${idColonne}/taches/${idTache}/commentaires`)
    } catch (err) {
      console.error(err)
